 ...
 */
public class AllphoneTranscriberDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        InputStream stream = AllphoneTranscriberDemo.class.getResourceAsStream("/edu/cmu/sphinx/demo/aligner/10001-90210-01803.wav");
        stream.skip(44);
