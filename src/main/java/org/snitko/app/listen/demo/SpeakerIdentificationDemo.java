...
public class SpeakerIdentificationDemo {
    ...
    /**
     * @param speakers An array of clusters for which it is needed to be printed the
     *                 speakers intervals
     * @param fileName THe name of file we are processing
     */
    ...
    /**
     * @param speakers An array of clusters for which it is needed to get the
     *                 speakers intervals for decoding with per-speaker adaptation
     *                 with diarization.
     * @param url      Url for the audio
    ...
    public static void main(String[] args) throws Exception {
        ...
        URL url = edu.cmu.sphinx.demo.speakerid.SpeakerIdentificationDemo.class.getResource("test.wav");
